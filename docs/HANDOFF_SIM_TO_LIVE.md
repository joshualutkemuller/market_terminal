...
|---|-------|---------|----------|--------|
| 1 | [Dashboard live indices](#build-1-dashboard-live-indices) | `/`, `/markets` | FRED + market_data_pipeline | [ ] Not started |
| 2 | [Liquidity early warning signals](#build-2-liquidity-early-warning-signals) | `/liquidity` | FRED (SOFR, EFFR, HY OAS) | [ ] Not started |
...
| 5 | [Cash optimizer live funding rates](#build-5-cash-optimizer-live-funding-rates) | `/cash-optimizer` | FRED (SOFR, CP, DFF) | [ ] Not started |
| 6 | [Reinvestment live yield curves](#build-6-reinvestment-live-yield-curves) | `/reinvestment` | FRED (Treasury curve) | [ ] Not started |
...
| # | Build | Page(s) | Pipeline | Status |
|---|-------|---------|----------|--------|
| 11 | [SecLending inventory price overlay](#build-11-seclending-inventory-price-overlay) | `/securities-lending` | market_data_pipeline | [ ] Not started |
...
|------|-------|--------|--------|
| 2026-06-24 | — | Initial plan and handoff created | — |
